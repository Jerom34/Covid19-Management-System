...
class LoadingScreen(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/loadingscreen.ui", self)
    ...
    def appProgress(self):
        ...
        if progressBarValue > 100:
            ...
            QtCore.QTimer.singleShot(
                0, lambda: self.loadingstatus.setText(" Connecting to Database"))
        elif progressBarValue < 50:
            QtCore.QTimer.singleShot(
                0, lambda: self.loadingstatus.setText("     Loading Database"))
        elif progressBarValue < 75:
            QtCore.QTimer.singleShot(
                0, lambda: self.loadingstatus.setText("        Please Wait.."))
...
class LoginScreen(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/login_design.ui", self)
    ...
    def ErrorDialog(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("images/covid19.png"),
...
class AdminDashboard(QMainWindow):
    def __init__(self):
        ...
        loadUi("user_interface_files/admindashboard.ui", self)
...
# <======================== PRINT FUNCTION TO OPEN A EXCEL FILE ========================>
    ...
    def PrintButton(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/printbutton.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
class AddPatient(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/addpatient.ui", self)
    ...
    def Added_msgbox(self):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/covid19.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        msg.setWindowIcon(icon)
...
class DeletePatient(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/deletepatient.ui", self)
    ...
    def Deleted_msgbox(self):
        ...
        msg.setIcon(QMessageBox.Information)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/covid19"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        msg.setWindowIcon(icon)
...
class UpdatePatient(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/updatepatient.ui", self)
...
class SearchPatient(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/searchpatient.ui", self)
    ...
    def InformationDialog(self):
        ...
        info_icon.addPixmap(QtGui.QPixmap("icons/covid19.png"),
                            QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
class UserLogin(QMainWindow):
    def __init__(self):
        ...
        loadUi("user_interface_files/userdashboard.ui", self)
        ...
        self.label_6.setStyleSheet(
            "image: url(stackedwidgets_pic/coronavirus-prevention-infographic_23-2148523347.jpg)")
        self.label_6.setText("")
        self.label_6.setPixmap(QtGui.QPixmap(
            "stackedwidgets_pic/coronavirus-prevention-infographic_23-2148523347.jpg"))
        ...
        self.label_7.setPixmap(QtGui.QPixmap(
            "stackedwidgets_pic/wiw2020-quote.png"))
        ...
        self.label_8.setPixmap(QtGui.QPixmap(
            "stackedwidgets_pic/20180705-I-quote-vaccines.png"))
    ...
    # <======================= BUTTON CONNECTION =======================>
        ...
        self.VaccinationArea_Button.clicked.connect(
            self.VaccinationAreasButton)
...
class ShowPersonalStatus(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/userinfo.ui", self)
...
class HealthDeclaration(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/healthdeclaration.ui", self)
        ...
        for i in self.cursor.fetchone():
            ...
            if self.result == "Positive":
                ...
                self.userimage.setStyleSheet(
                    u"image: url(icons/patient status.png)")
...
class VaccinationAreas(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/vaccinationareas.ui", self)
    ...
    # <========================== SEARCH FILTER ==========================>
        ...
        self.City_LineEdit.textChanged.connect(
...
class InfectedAreas(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/infectedareas.ui", self)
...
class CreateNewAcc(QWidget):
    def __init__(self):
        ...
        loadUi("user_interface_files/new_account.ui", self)
...
# <========================== REGISTER BUTTON FUNCTION ==========================>
    ...
    # <========================== CHECK RADIO BUTTONS - SET TO DATABASE ==========================>
        ...
        result = self.cursor.execute(
            "SELECT ID_NUMBER from patients WHERE USERNAME = ?", (username, ))
    ...
    def Added_msgbox(self):
        ...
        msg.setIcon(QMessageBox.Information)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("icons/check.png"),
                       QtGui.QIcon.Normal, QtGui.QIcon.Off)
        msg.setWindowIcon(icon)
